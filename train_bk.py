...
parser.add_argument('--train_list', default='/workspace/mnt/group/algorithm/kanghaidong/video_project/Video0.9_list_file/bk-video-list-V0.9-a-train-databalance.txt',type=str)
...
parser.add_argument('--train-frame-interval', type=int, default=2,
                    help="define the sampling interval between frames.")# interval 间隔
